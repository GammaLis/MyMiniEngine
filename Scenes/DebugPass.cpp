...
bool DebugPass::Init()
{
    // root signature
    {
        ...
        m_DebugRS.Finalize(Graphics::s_Device, L"DebugRS"); // RootFlags(0) , 不需要ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT
    }
    // PSO
    {
        ...
        m_DebugPSO.SetInputLayout(0, nullptr);  // 不需要输入，直接绘制 全屏三角形
