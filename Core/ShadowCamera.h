...
namespace MyDirectX
{
	...
	public:
		...
		void UpdateMatrix(
			const Math::Vector3 &lightDirection,	// direction parallel to light, in direction of travel
			const Math::Vector3 &shadowCenter,		// center location on far bounding plane of shadowed region
			const Math::Vector3 &shadowBounds,		// width, height, and depth in world space represented by the shadow buffer
