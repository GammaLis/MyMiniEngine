...
LinearAllocationPage* LinearAllocatorPageManager::RequestPage(ID3D12Device* pDevice)
{
...
LinearAllocationPage* LinearAllocatorPageManager::CreateNewPage(ID3D12Device* pDevice, size_t pageSize)
{
...
// LinearAllocator
DynAlloc LinearAllocator::Allocate(ID3D12Device* pDevice, size_t sizeInBytes, size_t alignment)
{
	...
	{
		m_CurPage = s_PageManager[(int)m_AllocationType].RequestPage(pDevice);
		m_CurOffset = 0;
	}
...
DynAlloc LinearAllocator::AllocateLargePage(ID3D12Device* pDevice, size_t sizeInBytes)
{
	LinearAllocationPage* oneOff = s_PageManager[(int)m_AllocationType].CreateNewPage(pDevice, sizeInBytes);
